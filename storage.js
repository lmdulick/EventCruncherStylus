...
//       console.log("Updating single face:", requestData);
...
//                 saved: [...(currentFiles.saved || []), ...(currentFiles.pending || [])],
//                 pending: [], // Clear pending files
//             };
//         }
...
//   //                 setFaceFiles((prev) => ({
//   //                     ...prev,
//   //                     [i]: { saved: [{ name: `${face}.bin`, url: fileURL }], pending: [] },
//   //                 }));
//   //             }
//   //         }
//   //       } else {
...
//                     setFaceFiles((prev) => ({
//                         ...prev,
//                         [i]: { saved: [{ name: `${face}.png`, url: fileURL }], pending: [] },
//                     }));
//                 }
//             } catch (fileError) {
